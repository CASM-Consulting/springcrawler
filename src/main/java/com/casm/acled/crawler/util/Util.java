...
//                    System.out.println(source);
    ...
    public SourceList createSourceList(String name, String query) {
        SourceList sourceList = EntityVersions.get(SourceList.class).current()
                ...
                ;
        return sourceListDAO.upsert(sourceList);
    }
    ...
    public void createFakeNetSourceList(int n) {
...
//                    .put(Source.CRAWL_SCHEDULE, "0 0 20 ? * TUE,FRI *")
                    .put(Source.CRAWL_SCHEDULE, "0 */5 * ? * *") // Every five minutes
                    .put(Source.CRAWL_DEPTH, 2)
                    ;
            sources.add(source);
        }
//        sources = sourceDAO.create(sources); // do upsert to overwrite
        ...
        SourceList list = EntityVersions.get(SourceList.class).current()
                ...
                .put(SourceList.CRAWL_ACTIVE, true)
...
//
//        SourceList sourceList = createSourceList("mexico-1", "(activist activists ambush ambushed ambushes ambushing arson assault assaulted attack attacked attacker attackers attacking attacks battle battled battles beaten beating blast bomb bombed bomber bombers bombing bombs casualties casualty clash clashed clashes clashing demonstrate demonstrated demonstraters demonstrates demonstrating demonstration demonstrations detonated explode exploded explodes exploding explosion explosions \"gun fire\" gunfire kidnapping killed killer killers killing knifed lynched lynching march marched marches marching \"mob justice\" molotov picket picketers picketing protest protested protester protesters protesting protestor protestors protests raid raided raiding raids rallied rallies rallying rape raped rapes raping rapist revolt revolts riot rioted rioter rioters rioting riots \"set on fire\" shooter shooters shooting shoots shot stab stabbed stabbing strike striked strikes \"threw stones\" \"throwing stones\" \"to shoot\" turmoil unrest vigilante vigilantism violence wounded narco drugs cartel beheaded \"narco message\" \"public hanging of corpses\" \"burned body\" \"burned bodies\" tied gagged \"shot of grace\" \"body encased in cement\" \"hit by a wooden board\" mutilated dismembered \"signs of torture\" \"human remains in plastic bags\" \"body wrapped in a blanket\" ransom kidnapper kidnapped hooded masked cocaine methamphetamine marijuana \"signs of violence\" \"advanced state of decomposition\" \"mass graves\" grave \"organized crime\" \"criminal band\" \"hunger strike\" arrests arrest \"to rescue\" migrant immigrant immigrants seizure seize extortion \"crystal meth\" \"throat slit\" abduction \"signs of restraint\" cardboard \"carboard message\" \"threatening message\" \"burned with acid\" corpse \"signs of sexual violence\" \"signs of rape\" handcuffs handcuffed \"feet tied\" torso \"human head\" execute \"armed men\" criminals \"community police\" self-defense \"fuel theft\" \"body found inside of a bin\" \"narco blockage\" \"blockage of roads\" \"fire weapon\" displaced body \"bone remains\" intercepted \"a chase\" captured \"drug dealing\" \"drug dealer\" \"poppy plants\" \"hands tied\" bodies activista defensor defensora activistas defensores defensoras emboscada emboscó emboscaron emboscados emboscando \"incendio provocado\" \"incendio malicioso\" \"incendio intencional\" agresión acoso asalto atacado atacada atacados agredido agredida agredidos acosado acosada acosados asaltado asaltada asaltados agredieron acosaron asaltaron agredió acosó asaltó ataque \"ataque a balazos\" atacó atacaron atacante aggresor perpetrador asaltante atacantes agresores perpetradores asaltantes atacando ataques batalla combate combatieron batallas combates golpeado sometido golpeada sometida golpeando sometiendo golperaron golpeó explosión ráfaga voladura bomba bombardeado bombardero bombarderos bombardeando bombas víctimas bajas muertos víctima baja muerto choque conflicto enfrentamiento chocó chocaron \"se enfrentó\" \"se enfrentaron\" choques enfrentamientos chocando enfrentando demostrar manfiestar demostraron manifestaron manifestantes demuestra manifiesta demostrando manifestando demostración manifestación demostraciones manifestaciones detonó explotar explotó explotaba explotando estallido explosiones estallidos disparo tiro tiroteo disparos tiros tiroteos secuestro plagio rapto levantón asesinado asesinada ejecutado ejecutada asesinaron asesinan asesino asesinos asesinato ejecución homicidio puñalado puñalada linchado linchada linchandos lincharon ajusticiarion linchando ajusticiar marcha marchó marcharon marchas marchando \"justicia popular\" \"justicia a mano propia\" piquete plantón piqueteros \"realizando un piquete\" \"montando un piquete\" protesta protestó protestaron manifestante protestando protestas plantones incursión redada incursionó incursionando incursiones redadas movilizó movilizaron movilizan movilizando violación violado violada viola violando violador violadora revuelta rebelión sublevación revueltas rebeliones sublevaciones disturbio motín desorden \"riña prisión\" \"riña cárcel\" \"riña penitenciario\" peleaban amontinó amotinaban \"causaban disturbios\" pelearon amontinaron \"causaron disturbios\" alborotador sublevado alborotadores sublevados desordenando alborotando sublevando desordenes alborotos disturbios \"prender fuego\" incediar \"prendieron fuego\" incendiaron \"prendió fuego\" incendió tirador pistolero tiradores pistoleros balazo balazos \"ráfaga de balas\" \"dar balas\" \"dar plomo\" tiró tiraba tiraron \"dieron balas\" \"dio balas\" \"dieron plomo\" plomeó plomearlo acribillado acribilaron \"abrieron fuego\" \"abrió fuego\" ballearon dispararon disparan disaparo disparado disparada disparar punzada estocada apuñalado apuñalada punzado estocado apuñalar punzar estocar huelga golpe paro \"toma de\" \"toma del\" holgó golpearon tomaron toman huelgas golpes paros tomas \"lanzó piedras\" \"tiró piedras\" \"lanzaron piedras\" \"tiraron piedras\" \"lanzando piedras\" balear balearon agitación crisis turbulencia malestar \"vigilante parapolicial\" comunitario comunitarios \"vigilancia parapolicial\" violencia herida herido heridos heridas baleado baleada baleadas baleados lesionado lesionados lesionada lesionadas narcos drogas estupefacientes narcóticos carteles decapitado decapitados decapitada decapitadas \"narco mensaje\" ahorcamiento ahorcado ahorcada \"cuerpo quemado\" \"cuerpo calcinado\" quemaduras \"cuerpos quemados\" \"cuerpos calcinados\" atado atada atados atadas amarrado amarrada amordazado amordazada \"tiro de gracia\" \"cuerpo encajonado en cemento\" \"cuerpo encajonado en concreto\" \"cuerpo en concreto\" \"cuerpo en bloques de concreto\" tableado tableada tablear tablearon tableados mutilado multilada multilados multiladas desmembrado descuartizado desmembrados desmembrada desmembradas descuartizada descuartizados descuartizadas \"signos de tortura\" \"huella de tortura\" \"huellas de tortura\" \"restos humanos\" embolzado embolzada embolzados embolzadas encobijado encobijada encobijados encobijadas rescate rescates secuestrador plagiador secuestrado secuestrada secuestrados secuestradas secuestraron plagiado plagiada plagiados plagiadas plagiaron raptado raptada raptados raptadas raptaron levantado levantada levantados levantadas levantaron \"privados de libertad\" \"privado de su libertad\" \"privada de su libertad\" encapuchado encapuchada paristas encapuchados enmascarado enmascarada cocaina metanfetamina marihuana \"plantas de marihuana\" \"signos de violencia\" \"marcas de violencia\" \"estado de descomposición\" \"putrefacción avanzada\" \"fosas comunes\" \"fosas clandestinas\" fosa \"delincuencia organizada\" \"banda criminal\" pandillas \"grupo criminal\" \"huelga de hambre\" arrestos detenciones arresto arrestado arrestada arrestados arrestadas arrestaron detienen arrestan detener detuvieron rescatar rescantan rescataron rescatado rescatada rescatados rescatadas migrante migrantes caravana \"caravana de migrantes\" inmigrante inmigrantes \"inmigrantes indocumentados\" \"inmigrantes ilegales\" incautación decomiso incautar decomisar extorsión \"meta crystal\" crystal cristal degollado degollada degollados secuestros \"señales de restricción\" \"signos de restricción\" cartulina \"mensaje en cartulina\" \"mensaje amenazante\" \"quemado con ácido\" \"cadaver u occiso\" \"signos de violencia sexual\" \"señales de violencia sexual\" \"signos señales de violación\" \"señales de violación\" esposas esposado esposados \"atado de pies\" maniatado \"cabeza humana\" ejecutar ejecutaron ejecutan \"hombres armados\" pandilleros delincuentes \"policia comunitaria\" autodefensas huachicolero entambado \"narco bloqueo\" bloqueo bloquean bloqueado bloqueada \"arma de fuego\" desplazado desplazada desplazados desplazadas cuerpo cuerpos cadáver \"restos óseos\" interceptaron interceptada interceptado persecución capturar capturaron capturado capturada narcomenudeo narcomenudista narcomenudistas amapola \"plantas de amapola\")");
//        link(sources, sourceList);

//        SourceList sourceList = sourceListDAO.byName("mexico-1").get();
//        Source source = sourceDAO.byName("Imagen del Golfo").get();
//        link(ImmutableList.of(source), sourceList);
    }
